...
var createEmscriptenModule = (() => {
  var _scriptDir = (typeof document !== "undefined" && document.currentScript && document.currentScript.src ? new URL("", document.currentScript.src).href : "");
...
["_main","_malloc","_free","_memory","___indirect_function_table","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('index.wasm', (typeof document !== "undefined" && document.currentScript && document.currentScript.src ? new URL("", document.currentScript.src).href : "")).href;
}
...
// end include: preamble.js
  ...
  var _emscripten_resize_heap = (requestedSize) => {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        var overGrownHeapSize = oldSize * (1 + -1 / cutDown); // ensure geometric growth
